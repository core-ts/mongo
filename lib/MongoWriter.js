...
var CRUDRepository = (function (_super) {
    ...
    function CRUDRepository(db, collectionName, attributes, toBson, fromBson) {
        var _this = _super.call(this, db, collectionName, attributes, fromBson) || this;
        _this.toBson = toBson;
    ...
    CRUDRepository.prototype.create = function (obj) {
    ...
    CRUDRepository.prototype.update = function (obj) {
        var _this = this;
        if (!this.version) {
    ...
    CRUDRepository.prototype.patch = function (obj) {
        var _this = this;
        if (!this.version) {
    ...
    CRUDRepository.prototype.save = function (obj) {
        var _this = this;
        if (!this.version) {
