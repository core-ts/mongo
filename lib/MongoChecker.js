...
var MongoChecker = (function () {
    ...
    MongoChecker.prototype.build = function (data, error) {
        if (error) {
            data.status = "DOWN";
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4, Promise.race([
                                this.db.admin().ping(),
                                new Promise(function (_, reject) { return setTimeout(function () { return reject(new Error("MongoDB health check timeout")); }, _this.timeout); }),
                            ])];
                    case 2:
                        _a.sent();
                        return [2, this.build({
